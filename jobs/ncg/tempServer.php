...
$worker->onWorkerStart = function ($worker) {
    ...
    if ($worker->id === $processId) {
        ...
        $start_time = '2023-03-22 14:00:00';
    ...
    if ($worker->id === $processId) {
        ...
        $game->orderByTime('2023-03-22 14:00:00', '2023-03-23 14:00:00');
    }
    ...
    if ($worker->id === $processId) {
        ...
        $start_time = '22023-03-22 14:00:00';
        $end_time = '2023-03-23 14:00:00';
        while (1) {
            $tmp_end_time = date('Y-m-d H:i:s', strtotime($start_time) + 3600);
            if ($tmp_end_time > $end_time) {
    ...
    if ($worker->id === $processId) {
        $interval = 120;
        $game = new \Logic\Game\Third\PG($app->getContainer());
        $game->orderByTime('1679461382194', '');
    }
